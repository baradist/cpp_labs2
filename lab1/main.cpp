...
int main() {
    ...
    //Задание 3.Спецификаторы доступа. Инкапсуляция.
    {
        ...
        int l, right, t, b;
        r.GetAll(l, right, t, b);
        std::cout << l << right << t << b << std::endl;
        {
            int l, right, t, b;
            const Rect r(1, 2, 2, 4);
            r.GetAll(l, right, t, b);
            cout << "stop" << endl;
        }
    }
    ...
    //неприятности Вас ожидают. Попробуйте исправить положение (как?)
    {
        ...
        // на новую
        str1.SetNewString("New Value");
        MyString usingDefaultConstructor;
        cout << "stop" << endl;
    }
